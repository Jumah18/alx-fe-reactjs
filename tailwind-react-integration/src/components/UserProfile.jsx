...
function UserProfile() {
    return (
      ...
      <div className="user-profile bg-gray-100 p-8 max-w-sm mx-auto rounded-lg  my-20 shadow-lg sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm sm:text-lg md:text-xl sm:text-sm md:text-base hover:shadow-xl" >
